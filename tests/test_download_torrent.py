...
class TestClient(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        urllib.request.urlretrieve(url, os.path.join(self.TEST_DIR, self.FILE_NAME))
    ...
    def test_fetch_peer_list(self):
        cl = Client()
        max_list_size = 10
        peers = cl.fetch_peer_list(
            os.path.join(self.TEST_DIR, self.FILE_NAME), max_list_size
        )
        print(peers)
    ...
    def test_download_piece(self):
        ...
        peers = cl.fetch_peer_list(
            os.path.join(self.TEST_DIR, self.FILE_NAME), max_list_size=3
        )
